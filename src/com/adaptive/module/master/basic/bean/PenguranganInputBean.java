...
@ManagedBean(name = "penguranganInputBean")
@ViewScoped
public class PenguranganInputBean extends FacesUtils implements Serializable{
	...
	public boolean isValidateBilangan(){
		...
		if(strBil1.isEmpty()){
			addFacesMsg(FacesMessage.SEVERITY_WARN, "formPengurangan:bilangan1",
					retrieveMessage("lblBil1") + " " + retrieveMessage("errorMustBeFilled"), null);
			valid = false;
		}
		if(strBil2.isEmpty()){
			addFacesMsg(FacesMessage.SEVERITY_WARN, "formPengurangan:bilangan2",
