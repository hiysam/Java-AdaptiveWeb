package com.adaptive.common.constant;
...
public interface CommonConstants {
	...
	final String ACTIVE_FLAG_Y = "Y";
	
	final String ACTIVE_FLAG_N = "N";
	
	final String ACTIVE_FLAG_YES = "Yes";
	
	final String ACTIVE_FLAG_NO = "No";
	
	final static String RECORD_FLAG_DELETE = "Delete";
	...
	public static final String NAVIGATE_STUDENT_UPLOAD = "studentUpload.jsf";
	public static final String NAVIGATE_STUDENT_MAIN = "studentMain.jsf";
	...
	public static final String PO_STATUS = "STATUS";
